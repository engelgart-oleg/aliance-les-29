<section class="section founder">
  ...
  <picture class="founder-photo">
    <source type="image/avif" srcset="img/founder_mobile.avif" media="(max-width: 768px)">
    <source type="image/webp" srcset="img/founder_mobile.webp" media="(max-width: 768px)">
    <source type="image/jpg" srcset="img/founder_mobile.jpg" media="(max-width: 768px)">
    <source type="image/avif" srcset="img/founder.avif">
  ...
  <div class="container founder-container">
    <div class="founder-content-wrapper">
      <div class="founder-content">
        ...
        <a class="button-link founder-link" href="#"><span class="founder-span-1">Подробнее о компании</span><span class="founder-span-2">О нашей компании</span></a>
      </div>
      <!-- /.founder-content -->
    </div>
